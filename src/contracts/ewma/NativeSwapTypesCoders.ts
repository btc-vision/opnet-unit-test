...
export class NativeSwapTypesCoders {
  ...
  public static decodeGetStakingContractAddressResult(response: CallResponse): GetStakingContractAddressResult {
    if (!response.response) {
  ...
  public static encodeSetStakingContractAddressParams(selector: number, to: Address): BinaryWriter {
    const calldata = new BinaryWriter();
