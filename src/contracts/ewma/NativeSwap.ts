...
export class NativeSwap extends ContractRuntime {
  ...
  public async getStakingContractAddress(): Promise<GetStakingContractAddressResult> {
    const calldata = NativeSwapTypesCoders.encodeGetStakingContractAddressParams(this.getStakingContractAddressSelector);
  ...
  public async setStakingContractAddress(to: Address): Promise<SetFeesResult> {
    const calldata = NativeSwapTypesCoders.encodeSetStakingContractAddressParams(this.setStakingContractAddressSelector, to);
